...
urlpatterns = [
    ...
    path('users/read/page/<int:page>/', adminapp.users, name='users_page'),
    path('users/update/<int:pk>/', adminapp.user_update, name='user_update'),
    path('users/delete/<int:pk>/', adminapp.user_delete, name='user_delete'),

    path('categories/create/', adminapp.category_create, name='category_create'),
    path('categories/read/', adminapp.categories, name='categories'),
    path('categories/read/page/<int:page>/', adminapp.categories, name='categories_page'),
    ...
    path('products/read/category/<int:pk>/page/<int:page>/', adminapp.products, name='products_page'),
